...
$plugin->version   = 2026081244;      // YYYYMMDDXX. This release.
...
$plugin->maturity  = MATURITY_ALPHA;  // Detect Blackboard-native exports and report them clearly (#150).
$plugin->release   = '0.72.1';
