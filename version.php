...
$plugin->version   = 2026062509;      // YYYYMMDDXX. This release.
...
$plugin->maturity  = MATURITY_ALPHA;  // Keep every interleaved prompt fragment in flow-wrapped items.
$plugin->release   = '0.39.5';
