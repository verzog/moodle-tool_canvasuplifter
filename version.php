...
$plugin->version   = 2026062501;      // YYYYMMDDXX. This release.
...
$plugin->maturity  = MATURITY_ALPHA;  // Chunked-upload hardening + settings discoverable under Admin tools.
$plugin->release   = '0.37.1';
