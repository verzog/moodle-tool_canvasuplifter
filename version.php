...
$plugin->version   = 2026062600;      // YYYYMMDDXX. This release.
...
$plugin->maturity  = MATURITY_ALPHA;  // Full GPLv3 licence text; refreshed README and changelog.
$plugin->release   = '0.39.6';
